...
Vue.component('products-components', require('./components/products/ProductsComponent.vue').default);
Vue.component('product-card-components', require('./components/products/ProductCardComponent.vue').default);
